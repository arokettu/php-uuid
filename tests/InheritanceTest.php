...
class InheritanceTest extends TestCase
{
    public function testInheritance(): void
    {
        ...
        self::assertInstanceOf(Rfc4122Variant1Uuid::class, $uuid1);
        ...
        self::assertInstanceOf(Rfc4122Variant1Uuid::class, $uuid2);
        ...
        self::assertInstanceOf(Rfc4122Variant1Uuid::class, $uuid3);
        ...
        self::assertInstanceOf(Rfc4122Variant1Uuid::class, $uuid4);
        ...
        self::assertInstanceOf(Rfc4122Variant1Uuid::class, $uuid5);
        ...
        self::assertInstanceOf(Rfc4122Variant1Uuid::class, $uuid6);
        ...
        self::assertInstanceOf(Rfc4122Variant1Uuid::class, $uuid7);
        ...
        self::assertInstanceOf(Rfc4122Variant1Uuid::class, $uuid8);
        ...
        self::assertNotInstanceOf(Rfc4122Variant1Uuid::class, $ulid);
        ...
        self::assertNotInstanceOf(Rfc4122Variant1Uuid::class, $nil);
        ...
        self::assertNotInstanceOf(Rfc4122Variant1Uuid::class, $max);
        ...
        self::assertNotInstanceOf(Rfc4122Variant1Uuid::class, $generic);
