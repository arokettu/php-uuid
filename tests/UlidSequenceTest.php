...
class UlidSequenceTest extends TestCase
{
    public function testSequences(): void
    {
        ...
        foreach ($sequences as ['num' => $num, 'reserve' => $reserve, 'v7' => $v7, 'uuids' => $uuids]) {
            ...
            $seq = UuidFactory::ulidSequence($v7, $reserve, $clock, $randomizer);
    ...
    public function testProperRandomizer(): void
    {
        ...
        $sequence = UuidFactory::ulidSequence(true, true, $clock, $randomizer);
        ...
        $sequence = UuidFactory::ulidSequence(false, true, $clock, $randomizer);
    ...
    public function testOverflowWorstCase(): void
    {
        ...
        $sequence = UuidFactory::ulidSequence(false, false, new StaticClock(), $randomizer);
        $sequence->next();
    ...
    public function testOverflowWorstCaseV7Compatible(): void
    {
        ...
        $sequence = UuidFactory::ulidSequence(true, false, new StaticClock(), $randomizer);
        $sequence->next();
    ...
    public function testIterator(): void
    {
        ...
        $seq1 = UuidFactory::ulidSequence(false, true, $clock, new Randomizer(new Xoshiro256StarStar(123)));
        $seq2 = UuidFactory::ulidSequence(false, true, $clock, new Randomizer(new Xoshiro256StarStar(123)));
